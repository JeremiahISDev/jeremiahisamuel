    ...
    <>
      ...
      <div id="Container" className=" text-center mx-auto space-y-2 lg:space-y-0 lg:gap-2 lg:grid lg:grid-cols-6 p-6 content-center justify-center">
        <Link href="Games/Slope"><div className="cursor-pointer w-fit">
          <div class="w-fit rounded-[2.5rem] hover:drop-shadow-[0_35px_35px_rgba(0,0,0,0.25)]">
          ...
          <div class="pt-2">Slope</div>
        </div>
        </Link>
        <Link href="Games/StuntCars"><div className="cursor-pointer w-fit"><div class="w-fit rounded-[2.5rem] hover:drop-shadow-[0_35px_35px_rgba(0,0,0,0.25)]">
          <img src="https://madalinstuntcars2.io/data/image/madalin-cars-multiplayer1.jpg"
            alt="Stunt Cars" className="rounded-lg w-40 h-40" />

        </div><div class="pt-2">Madalin Stunt Cars</div>
        </div>
        </Link>

         <Link href="Games/AmongUs"><div className="cursor-pointer w-fit"><div class="w-fit rounded-[2.5rem] hover:drop-shadow-[0_35px_35px_rgba(0,0,0,0.25)]">
          <img src="https://seeklogo.com/images/A/among-us-logo-315EB5A5DA-seeklogo.com.png"
            alt="Among Us" className="rounded-lg w-40 h-40" />

        </div><div class="pt-2">Among Us</div>
        </div>
        </Link>

        <Link href="Games/CookieClicker"><div className="cursor-pointer w-fit"><div class="w-fit rounded-full hover:drop-shadow-[0_35px_35px_rgba(0,0,0,0.25)]">
        ...
        </div><div class="pt-2">Cookie Clicker</div>
        </div>
        </Link>

        <Link href="Games/HexGL"><div className="cursor-pointer w-fit"><div class="w-fit rounded-[2.5rem] hover:drop-shadow-[0_35px_35px_rgba(0,0,0,0.25)]">
        ...
        </div><div class="pt-2">HexGL</div>
        </div>
        </Link>

        <Link href="Games/RollingSky"><div className="cursor-pointer w-fit"><div class="w-fit rounded-[2.5rem] hover:drop-shadow-[0_35px_35px_rgba(0,0,0,0.25)]">
        ...
        </div><div class="pt-2">Rolling Sky</div>
        </div>
        </Link>
      </div>
    </>
